...
async function loadAndDisplayReviews(productId) {
    ...
    try {
        const response = await fetch(`/api/get-product-reviews?productId=${productId}`);
...
async function fetchMenu() {
    try {
        ...
        // --- THIS WAS THE PROBLEM. CHANGED '/api/menu' TO '/api/get-menu' ---
...
async function fetchAndDisplayStaticPage(pageName) {
    ...
    switch(pageName) {
        case 'about_us':
            endpoint = '/api/admin/about_us'; // Use the API endpoint for About Us
            break;
            case 'our_mission':
            endpoint = '/api/admin/our_mission';
            break;
            case 'privacy_policy':
            endpoint = '/api/admin/privacy_policy';
            break;
            case 'terms_and_conditions':
            endpoint = '/api/admin/terms_and_conditions';
            break;
...
async function handleReviewSubmit(e, orderId) {
    ...
    try {
        ...
        await fetchWithAuth('/api/submit-review', {
            method: 'POST',
